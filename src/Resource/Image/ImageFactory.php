...
/**
 * \LaminasPdf\Resource\Image\ImageFactory
 *
...
class ImageFactory
{
    public static function factory($filename): \LaminasPdf\Resource\Image\Tiff|\LaminasPdf\Resource\Image\Png|\LaminasPdf\Resource\Image\Jpeg
    {
        if (!is_file($filename)) {
