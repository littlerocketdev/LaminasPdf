    ...
    public function encodeString($string, $charEncoding): string
    {
        ...
        for ($i = 0; $i < strlen($string); $i++) {
            ...
            if (isset($this->_toFontEncoding[$characterCode])) {
                ...
                /* For now, mimic the behavior in \LaminasPdf\Font::encodeString()
